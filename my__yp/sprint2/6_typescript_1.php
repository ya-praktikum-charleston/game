...
<div class="linear" id="Hello">
    ...
    <p><b>Задача 1 - Пространство имён</b></p>

    <p>Напишите функцию, которая создаёт пространство имён. На вход подаётся строка вида: <code>a.b.c.d.e</code>, на выходе — вложенные друг в друга объекты</p>
    ...
    <pre class="brush: js;">
        ...
        function namespace(val){
            ...
            return arr.reduceRight(function(total, initialValue , index, array) {

                let mass = {}
                if(index === array.length-2){
                    let last = {};
                    last[total] = {};
                    mass[initialValue] = last;
                }else{
                    mass[initialValue] = total
                }
    ...
    <br>
    <p><b>Задача 2 - Реактивность</b></p>

    <p>Реализуйте «реактивность» на основе <code>defineProperty</code>. Необходимо, чтобы при написании текста в инпуте, в текстовое поле сразу подставлялись значения. </p>
