...
function t7() {
    ...
    fetch('http://getpost.itgid.info/index2.php?auth=zhrgB3DxC8LoG7Gcisjc&action=7')
        .then(data => data.text())
        .then(data => {
            document.querySelector('.out-7').innerHTML = `<img src="${data}" alt="">`;
        });
}
...
function t9() {
    ...
    fetch('http://getpost.itgid.info/index2.php?auth=zhrgB3DxC8LoG7Gcisjc&action=9&y=1')
        .then(data => data.text())
        .then(data => {
...
function t16() {
    ...
    fetch('http://getpost.itgid.info/index2.php',{
        ...
        .then(data => data.text())
        .then(data => {
            document.querySelector('.out-16').innerHTML = `<img src="${data}" alt="">`;
        });
}
...
function t18() {
    ...
    fetch('http://getpost.itgid.info/index2.php',{
        ...
        body: 'auth=zhrgB3DxC8LoG7Gcisjc&action=9&y=1'
    })
        .then(data => data.text())
        .then(data => {
