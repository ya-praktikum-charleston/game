...
function t1(e) {
    ...
    document.querySelector('.out-1').innerHTML = txt;
}
...
function t2(e) {
    ...
    document.querySelector('.out-2').innerHTML = bul;
}
...
function t3(e) {
    let w = e.toElement.offsetWidth;

    this.style.width = w + 5 + 'px';
    document.querySelector('.out-3').innerHTML = w + 5 + 'px';
}
...
function t4(e) {
    ...
    document.querySelector('.out-4').innerHTML = txt;
}
...
function t9(e) {
    let url = 'img/2.png';
    this.firstElementChild.setAttribute('src', url);
...
function t11() {
    let $el = document.querySelector('.div-11');

    $el.onmouseenter = function(){
        this.firstElementChild.setAttribute('src', 'img/2.png');
    }
    $el.onmouseleave = function(){
        this.firstElementChild.setAttribute('src', 'img/1.png');
    }
}
...
let t13_div = document.querySelector('.div-13');

t13_div.onmousedown = (e) => {
    e.target.classList.add('active');
}
...
function t18(e) {
    ...
    document.querySelector('.out-18').innerHTML = w + 'px';
}
