...
function t2() {
    ...
    xhttp.open("GET", "http://getpost.itgid.info/index2.php?auth=zhrgB3DxC8LoG7Gcisjc&action=2&name=vit", true);
    xhttp.send();
}
...
function t3() {
    ...
    xhttp.open("GET", "http://getpost.itgid.info/index2.php?auth=zhrgB3DxC8LoG7Gcisjc&action=3&num1=1&num2=2", true);
    xhttp.send();
}
...
function t4() {
    ...
    xhttp.open("GET", "http://getpost.itgid.info/index2.php?auth=zhrgB3DxC8LoG7Gcisjc&action=4&num1=1&num2=10", true);
    xhttp.send();
}
...
function t6() {
    ...
    xhttp.open("GET", "http://getpost.itgid.info/index2.php?auth=zhrgB3DxC8LoG7Gcisjc&action=6&num1=1&num2=10", true);
    xhttp.send();
}
...
function t7() {
    xhttp.onreadystatechange = function () {
        if (this.readyState == 4 && this.status == 200) {
            document.querySelector('.out-7').innerHTML = `<img src="${this.responseText}" alt="">`;
        }
    };
...
function t8() {
    ...
    xhttp.open("GET", "http://getpost.itgid.info/index2.php?auth=zhrgB3DxC8LoG7Gcisjc&action=8&year=1987", true);
    xhttp.send();
}
...
function t9() {
    ...
    xhttp.open("GET", "http://getpost.itgid.info/index2.php?auth=zhrgB3DxC8LoG7Gcisjc&action=9&y=1", true);
    xhttp.send();
}
...
function t11() {
    ...
    xhttp.open("POST", "http://getpost.itgid.info/index2.php?auth=zhrgB3DxC8LoG7Gcisjc&action=2&name=vit", true);
    xhttp.send();
}
...
function t12() {
    ...
    xhttp.open("POST", "http://getpost.itgid.info/index2.php?auth=zhrgB3DxC8LoG7Gcisjc&action=3&num1=1&num2=2", true);
    xhttp.send();
}
...
function t13() {
    ...
    xhttp.open("POST", "http://getpost.itgid.info/index2.php?auth=zhrgB3DxC8LoG7Gcisjc&action=4&num1=1&num2=10", true);
    xhttp.send();
}
...
function t15() {
    ...
    xhttp.open("POST", "http://getpost.itgid.info/index2.php?auth=zhrgB3DxC8LoG7Gcisjc&action=6&num1=1&num2=10", true);
    xhttp.send();
}
...
function t16() {
    xhttp.onreadystatechange = function () {
        if (this.readyState == 4 && this.status == 200) {
            document.querySelector('.out-16').innerHTML = `<img src="${this.responseText}" alt="">`;
        }
    };
...
function t17() {
    ...
    xhttp.open("POST", "http://getpost.itgid.info/index2.php?auth=zhrgB3DxC8LoG7Gcisjc&action=8&year=1987", true);
    xhttp.send();
}
...
function t18() {
    ...
    xhttp.open("POST", "http://getpost.itgid.info/index2.php?auth=zhrgB3DxC8LoG7Gcisjc&action=9&y=1", true);
    xhttp.send();
}
